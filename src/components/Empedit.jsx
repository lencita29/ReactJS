...
export default function Edit() {
  ...
  return (
    <div><h1>Edit</h1>
        ...
        <TextField value={employe.name}  name='name'  onChange={handleChange} id="outlined-basic" label="Enter your name" variant="outlined" size="small" /><br/><br/>
        <TextField value={employe.phone} name='phone' onChange={handleChange} id="outlined-basic" label="Enter your phone" variant="outlined" size="small" /><br/><br/>
        <TextField value={employe.email} name='email' onChange={handleChange} id="outlined-basic" label="Enter your email" variant="outlined" size="small" /><br/><br/>
        <TextField value={employe.address} name='address' onChange={handleChange} id="outlined-basic" label="Enter your email" variant="outlined" size="small" /><br/><br/>
        <TextField value={employe.salary} name='salary' onChange={handleChange} id="outlined-basic" label="Enter your email" variant="outlined" size="small" /><br/><br/>
